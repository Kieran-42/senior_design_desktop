...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            '/zed/zed_node/left/image_rect_color/points@sensor_msgs/msg/PointCloud2[gz.msgs.PointCloudPacked',
        ...
        remappings=[
            ...
            ('/zed/zed_node/left/image_rect_color', '/zed/zed_node/rgb/image_rect_color'),
            ('/zed/zed_node/left/image_rect_color/depth_image', '/zed/zed_node/depth/depth_registered'),
            ('/zed/zed_node/left/image_rect_color/points', '/zed/zed_node/point_cloud/cloud_registered'),
            ('/zed/zed_node/tf', '/tf'),
        ],
        output='screen',
    )
